...
## Ingeniería de Software | Ciclo 2024-02 
...
|---------|------------|----------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| TB1       | 22/08/2024 | Aranda Vallejos, Oscar Gabriel <br><br> Chirinos Zuñiga, Rodrigo Manuel <br><br> Cantoral Sedamano, Alexander ALberto <br><br> Quispe Tipo, Godofredo <br><br> Gomez Hurtado, Miguel Angel | Se redactó la descripción de la startup, los antecedentes y la problemática. Además, se desarrolló el Lean UX Process y se delimitó el segmento objetivo.<br><br> Se completó la sección de Competidores (Incluyendo un análisis competitivo y tácticas frente a competidores). <br><br> Se realizó el diseño de entrevistas, el to-be scenario mapping y el impact mapping. <br><br> Se realizó el Needfinding para obtener las user personas, los user task matrix y el user journey mapping. <br><br> Se completó el Needfinding para obtener el emphaty mapping, el as-is scenario mapping y el lenguaje ubicuo. <br><br> Se desarrollaron los wireframes y prototipos de la landing page y web application. <br><br> Se realizaron los Web Applications Wireflow Diagrams. <br><br> Se realizaron los diagramas c4, el DDD, diagramas de clase y de base de datos. <br><br> Se realizó el despliegue de la landing page usando Github Pages. <br><br>   |
| TP      | 22/08/2024 | Aranda Vallejos, Oscar Gabriel <br><br> Chirinos Zuñiga, Rodrigo Manuel <br><br> Cantoral Sedamano, Alexander ALberto <br><br> Quispe Tipo, Godofredo <br><br> Gomez Hurtado, Miguel Angel | Se aplicó mejora continua, añadiendo descripciones a los prototipos y modelos diseñados de la landing page y web application. <br><br> Se realizó la primera versión del frontend dividido en 5 bounded context del modelo principal de negocio y se realizó su despliegue con firebase.  |
| TB2      | 22/08/2024 | Aranda Vallejos, Oscar Gabriel <br><br> Chirinos Zuñiga, Rodrigo Manuel <br><br> Cantoral Sedamano, Alexander ALberto <br><br> Quispe Tipo, Godofredo <br><br> Gomez Hurtado, Miguel Angel | Se realizó la primera versión del backend con Java y SpringBoot de manera individual. |
| TF      | 22/08/2024 | Aranda Vallejos, Oscar Gabriel <br><br> Chirinos Zuñiga, Rodrigo Manuel <br><br> Cantoral Sedamano, Alexander ALberto <br><br> Quispe Tipo, Godofredo <br><br> Gomez Hurtado, Miguel Angel | Las technical stories fueron añadidas al trello y al sprint. <br><br> Se realizó la unión y despliegue del backend. <br><br> Se implementó la conexión del backend con el front. <br><br> Se adaptaron y corregieron los services para su correcto funcionamiento con el backend. <br><br> Se aplicaron mejoras y actualizaciones en la base de datos, diagrama de clase y en el capítulo IV referente al Product Design. |
...
|-----------------------------------|
| https://github.com/orgs/SI729-2402-WS51-Grupo-3-Nido-Urbano/repositories |
...
|--------------------------------------------------------------------------------------------------------------|------------------------|--------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Aranda Vallejos, Oscar Gabriel**<br><a class="italic">TB1</a><br> Comunicó de manera oral los avances en el diseño de la landing page y el web application.<br><a class="italic">TP</a><br>Comunicó el desarrolló del deployment del front end para el bounded contexto de house appointments orientado en las historias de usuario de la EPIC005.<br><a class="italic">TB2</a><br>Comunicó las acciones y cambios realizados en el backend que afectarán a otros bounded context con la persona encargada <br><a class="italic">TF</a><br>Comunicó el proceso de conexión del back con el front y los errores presentados en videollamada para solucionarlos de manera rápida y en equipo. <br><br> **Cantoral Sedamano, Alexander ALberto**<br><a class="italic">TB1</a><br> Empleó de forma exitosa la entrevista y se encuentra preparado para la exposición del desarrollo del review del sprint 1 <br><a class="italic">TP</a><br>Para está entrega pude comunicarme de forma acertiva con un interesado para que vea como desarollo mi feat que se me asignó a mi persona y este pudiera entender como iba tomando forma mi idea. <br><a class="italic">TB2</a><br> Comuniqué las mejoras pendientes y expresé de manera continua mi avance en el aspecto de los contratos. <br><a class="italic">TF</a><br> Comunicó los items y validaciones necesarios para el sprint 4. Asimismo expresó que su backend ya estaba completo. <br><br> **Chirinos Zúñiga, Rodrigo Manuel**<br><a class="italic">TB1</a><br> Comunicó de manera rápida los criterios de aceptación para tener un mejor proceso de abstracción.<br><a class="italic">TP</a><br>Para el desarrollo del bounded context de Feedbacks, seguí los user stories que están relacionados con dicho bounded context y los implementé con eficiencia.<br><a class="italic">TB2</a><br>Comunicó en clase que el progreso de su bounded context (feedback) estaba bien encaminado y realizó una demostración de su avance.<br><a class="italic">TF</a><br>Comunicó de manera temprana la culminación de su backend con los atributos y value object faltantes mediante chat de voz. <br><br> **Gomez Hurtado, Miguel Angel**<br><a class="italic">TB1</a><br> Coordinó las reuniones del grupo de trabajo y presentó de manera constante pequeños avances en reuniones presenciales despues de clases y reuniones virtuales durante la semana.<br><a class="italic">TP</a><br>Durante el desarrollo de las 4 historias de usuario (US) de front-end relacionadas al bound context de payments, se aseguró de comunicar de manera clara los requerimientos técnicos y las funcionalidades que se implementaron, tanto en reuniones presenciales como virtuales. Adaptó su lenguaje al contexto del equipo técnico y los stakeholders, asegurando que todos comprendieran los avances y posibles retos.<br><a class="italic">TB2</a><br>Comunicó que el bounded context (payments) de su backend no podría ser presentado para el Sprint correspondiente debido a que aún estaba en desarrollo.<br><a class="italic">TF</a><br>Comunicó que completó su backend y levantó observaciones anteriores respecto a su bounded context por chat de voz. Programó reuniones ante la presencia de errores que involucraran otros bounded context. <br><br> **Quispe Tipo, Godofredo**<br><a class="italic">TB1</a><br> Durante el desarrollo del entregable, me aseguré de comunicarme de manera efectiva con diferentes rangos de audiencia. En las entrevistas, adapté mi lenguaje según el perfil de cada entrevistado, asegurándome de que comprendieran claramente las preguntas y confirmando los puntos clave al finalizar. Al elaborar el trabajo, presenté la información de forma accesible para diferentes audiencias, profundizando en aspectos técnicos con el equipo especializado y enfocándome en resultados claros. Además, coordiné reuniones en las que utilicé formatos visuales y fomenté la interacción para asegurar que todos los involucrados comprendieran los avances y objetivos. <br><a class="italic">TP</a><br> Solicitó reuniones por chat de voz en plataformas como GoogleMeet y Discord para comentar nuestros avances. <br><a class="italic">TB2</a><br> Transmitió y presentó en clase el avance del backend del bounded context relacionado a las adición de propiedades inmobiliarias. <br> <a class="italic">TF</a><br> Organizó reuniones de emergencia para soluciones errores críticos que afectaran a más de un bounded context. <br><br>  |<a class="italic">TB1</a><br>El equipo ha mejorado la capacidad de adaptar el lenguaje según la audiencia, usando un vocabulario accesible para no técnicos y técnico en discusiones especializadas.<br><br>Hemos logrado comunicar ideas técnicas complejas de forma clara y estructurada, asegurando que los puntos principales sean comprendidos.<br><br>El uso de herramientas visuales como diagramas y presentaciones ha facilitado la comprensión y mejorado la comunicación con diferentes audiencias.<br><br><a class="italic">TP</a><br> La comunicación continua y efectiva con diferentes stakeholders ha sido clave en el desarrollo del proyecto. Los miembros del equipo han demostrado la capacidad de comunicarse de manera precisa con interesados internos y externos, asegurando que todos los aspectos importantes del proyecto estén alineados. <br><br> La integración de herramientas de comunicación en línea, como GoogleMeet y Discord, ha facilitado la colaboración a distancia, lo que ha permitido que el equipo resuelva problemas rápidamente y mantenga una comunicación constante sobre avances y cambios. <br><br> Los informes sobre el progreso y los desafíos han sido claros, lo que ha permitido a los interesados tomar decisiones informadas y aportar feedback útil. <br><br><a class="italic">TB2</a><br> La comunicación sobre los problemas y los posibles retrasos en el desarrollo ha sido transparente, asegurando que los errores del equipo sean identificados rápidamente para poder ser corregidos en los siguientes sprint. <br><br><a class="italic">TF</a><br> El equipo ha mostrado una buena disposición para resolver los problemas de manera colaborativa, organizando reuniones de emergencia cuando era necesario para abordar errores críticos que involucraban múltiples bounded contexts. <br><br> La capacidad de informar sobre los avances de manera continua y anticipada ha permitido una mejor gestión del tiempo y la coordinación entre los miembros del equipo, reduciendo el impacto de los retrasos y mejorando el flujo del proyecto en general. <br><br> |
| Comunica por escrito con efectividad a diferentes rangos de audiencia. | **Aranda Vallejos, Oscar Gabriel**<br><a class="italic">TB1</a><br> Comunicó y registró por escrito las entrevistas de usuario de manera efectiva.<br><a class="italic">TP</a><br>Estableció un registró de las historias de usuario implementadas con dos posibles escenarios y un flujo especificado en archivos .feature. <br><a class="italic">TB2</a><br> Redactó en escrito y de manera general al grupo las observaciones del sprint que debían ser levantadas <br> <a class="italic">TF</a><br> Planificó por escrito el horario de las reuniones para solventar errores o dudas de manera rápida. Además comunicó el funcionamiento de la interfaz y los servicios de manera sencilla a usuarios interesados en el producto. <br><br>**Cantoral Sedamano, Alexander ALberto**<br><a class="italic">TB1</a><br> Siguiendo lo enseñado en cursos anteriores y consiguió que de desarrolle de manera exitosa sus responsabilidades establecidas para el Sprint número 1. <br><a class="italic">TP</a><br>Durante el segundo sprint pude escribir documentación compresible para todo tipo de audiencias usando lo aprendido en cursos anteriores de la carrera.<br><a class="italic">TB2</a><br> Comunicó la información relevante para el sprint 3 de manera escrita y recordó al grupo la importancia de realizar las entrevistas de validación y los videos about the team, product. <br><a class="italic">TF</a><br> Comentó por escrito los items necesarios para el sprint y las acciones que debemos cumplir para culminar el proyecto de manera eficiente. <br><br> **Chirinos Zúñiga, Rodrigo Manuel**<br><a class="italic">TB1</a><br> Solicitó a cada entrevistador que compartiera las necesidades identificadas para avanzar con los User Stories, destacando la importancia de considerar a nuestros competidores en el análisis para mejorar nuestra estrategia. Estableció revisar las respuestas en conjunto para obtener aprobación y avanzar en el proyecto, manteniendo un tono profesional y accesible. <br><a class="italic">TP</a><br>Se detalló las 3 user stories relacionadas con el bounded context de Feedback, incluyendo su descripción y escenarios correspondientes. <br><a class="italic">TB2</a><br> Colocó de manera escrita los errores en consola al momento de conectar el back con el front <br><a class="italic">TF</a><br> Solucionó errores y comentó por escrito los cambios que realizó en el código. <br><br> **Gomez Hurtado, Miguel Angel**<br><a class="italic">TB1</a><br> Entregó sus avances, como los diagramas de C4, el impact mapping, ubiquitous languague, empathy mapping. <br><a class="italic">TP</a><br>Redacto y documentó las 4 historias de usuario (US) de front-end relacionadas a payment de manera detallada, incluyendo los criterios de aceptación y descripciones técnicas claras. Se aseguró de que tanto el equipo de desarrollo como otros interesados pudieran entender fácilmente las especificaciones, ajustando el nivel de detalle en función de la audiencia. <br><a class="italic">TB2</a><br> Comunicó por escrito que el tiempo propuesto para las actividades en el sprint no concordaban con la realidad. <br><a class="italic">TF</a><br> Agregó funcionalidad al front, redactando y explicando los cambios realizados. <br><br> **Quispe Tipo, Godofredo**<br><a class="italic">TB1</a><br>Me comuniqué con algunos entrevistados a través de WhatsApp, donde coordiné de manera clara y efectiva la fecha y hora de las entrevistas, ajustando el tono y detalle de los mensajes según el perfil del entrevistado. Para la gestión de algunas tareas, utilicé el chat grupal en WhatsApp, donde dejaba por escrito las asignaciones, asegurándome de que todos los miembros del equipo entendieran sus responsabilidades. Además, mantuve un seguimiento activo, informando por escrito cuando las tareas estaban completadas y listas para su revisión, garantizando una comunicación fluida y efectiva entre los diferentes integrantes del grupo. <br><a class="italic">TP</a><br> Escribió mensajes expresando las tareas que debían ser terminadas con prioridad para garantizar un buen entregable. <br><a class="italic">TB2</a><br> Comunicó por escrito las secciones que debían pasar a segundo plano para poder enfocarnos en presentar un producto mínimo viable y la primera versión de los servicios web. <br><a class="italic">TF</a><br> Comunicó por escrito las secciones del código y documentación que necesitaban revisión gneral del equipo. <br><br>  |<a class="italic">TB1</a><br>El equipo ha mejorado en la redacción de informes técnicos detallados para audiencias especializadas y resúmenes ejecutivos simplificados para stakeholders no técnicos.<br><br>Hemos aprendido a estructurar documentos de manera clara y concisa, lo que facilita la comprensión de ideas complejas por parte de diferentes tipos de lectores.<br><br>La revisión colaborativa de los textos ha permitido asegurar la coherencia y efectividad en la comunicación escrita, ajustando el nivel de detalle según la audiencia destinataria. <br><br><a class="italic">TP</a><br> Se ha logrado un progreso significativo en la capacidad de redactar documentación comprensible para todo tipo de audiencias. El equipo ha aprendido a utilizar un lenguaje accesible y técnico según sea necesario, garantizando que las personas involucradas en el proyecto, independientemente de su nivel de conocimiento, puedan comprender los puntos clave del desarrollo. Esto ha facilitado la toma de decisiones informadas y el seguimiento eficiente de las tareas durante los sprints. <br><br><a class="italic">TB2</a><br> En la TB2, aunque se lograron avances, se evidenció la necesidad de mejorar en la documentación de errores y en la priorización clara de las tareas. La falta de detalles precisos al comunicar incidencias o al ajustar prioridades afectó la eficiencia en la resolución de problemas y la coordinación del equipo. Es fundamental que, en el futuro, se tome más en cuenta el tiempo asignado a cada tarea para evitar retrasos innecesarios. La correcta estimación de tiempos y la documentación de soluciones de manera detallada no solo facilitarán una mejor comprensión entre los miembros del equipo, sino que también permitirán un flujo de trabajo más ágil y una toma de decisiones más rápida. Establecer un formato claro y organizado para la gestión de tareas y tiempos contribuirá a mejorar la comunicación y optimizar el desarrollo del proyecto. <br><br><a class="italic">TF</a><br> El equipo ha demostrado una mejora notable en la planificación y ejecución de tareas, así como en la claridad de la comunicación escrita, lo que ha facilitado la coordinación y la resolución rápida de problemas. La comunicación efectiva sobre el estado de las tareas y la disposición para recibir retroalimentación ha permitido avanzar de manera más eficiente en el proyecto, minimizando retrasos y maximizando la productividad. También se ha logrado comunicar de manera clara el funcionamiento de los componentes del sistema, ayudando a los usuarios a comprender cómo interactuar con ellos sin confusión. <br><br> |
